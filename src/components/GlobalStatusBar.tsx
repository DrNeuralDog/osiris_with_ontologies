    ...
    >
      <div className="h-[28px] overflow-hidden bg-[#0a0a0f]/95 border-t border-white/[0.06] flex items-center text-[10px] font-mono tracking-wider backdrop-blur-xl relative">
        ...
        <div className="flex-shrink-0 h-full flex items-center pointer-events-auto">
          ...
          <Link href="/docs" prefetch title={uiText("Documentation & API Reference")} aria-label={uiText("Documentation & API Reference")}
          ...
          >
            <DocsIcon />
            <span className="text-[9px] font-bold tracking-[0.15em] uppercase">{uiText("Docs")}</span>
          </Link>
          {/* Data & privacy — what leaves this instance, and when */}
          <Link href="/privacy" title={uiText("Data & Privacy")} aria-label={uiText("Data and Privacy")}
          ...
          >
            <span className="text-[9px] font-bold tracking-[0.15em] uppercase">{uiText("Privacy")}</span>
          </Link>
        </div>
        ...
        <div className="flex-shrink-0 h-full flex items-center pointer-events-auto border-l border-white/[0.04]">
          ...
          <div className="h-full px-3 flex items-center gap-1.5">
            ...
            <span className="text-[#00E676]/70 text-[9px] tracking-[0.2em]">{uiText("ONLINE")}</span>
          </div>
        </div>
      </div>
        ...
        <div className="absolute bottom-[34px] left-1/2 -translate-x-1/2 z-[300] pointer-events-none">
          <div className="bg-black/90 backdrop-blur-xl border border-white/[0.08] rounded-lg px-4 py-3 text-[11px] font-mono whitespace-nowrap shadow-2xl">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-bold text-[#FF5722]">{uiText("Magnitude")}{" "}{hoveredQuake.magnitude.toFixed(1)}</span>
            ...
            <div className="flex flex-col gap-1 text-[10px]">
              <div className="text-white/50"><span className="text-white/30">{uiText("Depth:")}</span> {hoveredQuake.depth} km</div>
              <div className="text-white/50 mt-1"><span className="text-white/30">{uiText("Time:")}</span> {new Date(hoveredQuake.time).toLocaleString()}</div>
            </div>
          </div>
        </div>
      )}
